...
class ChaineInfoScreen extends StatefulWidget {
  const ChaineInfoScreen({super.key});

  @override
  State<ChaineInfoScreen> createState() => _ChaineInfoScreenState();
}

class _ChaineInfoScreenState extends State<ChaineInfoScreen> {
  @override
